  ...
  return(
    <Switch>
      ...
      <Route exact path="/home" component={Home} />
        ...
        <Route exact path="/DashboardPages" component={DashboardPages} />
        <Route exact path="/AdminDashboard" component={AdminDashboard} />
        <Route exact path="/StudentDashboard" component={StudentDashboard} />
        <Route exact path="/DashboardPages/AddOwnerdetails" component={AddOwnerdetails} />
        <Route exact path="/DashboardPages/Profile" component={Profile} />
