    ...
    return (
        <div className="section1">
                ...
                <div className="banner">
                    <div ><img className="images" src="/images/img1.jpeg"/></div>
                    <div ><img className="images" src="/images/img2.jpeg" /></div>
                    <div ><img className="images" src="/images/img3.jpeg"/></div>
                    <div ><img className="images" src="/images/img4.jpeg"/></div>
                    <div ><img className="images" src="/images/img5.jpeg"/></div>
                    <div ><img className="images" src="/images/img6.jpeg"/></div>
